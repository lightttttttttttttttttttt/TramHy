        ...
        <div className="container" style={{ maxWidth: 'var(--page-max-width)' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '24px', marginTop: '60px' }}>
            {[
              ...
              { name: 'Bul Nguyễn Makeup', type: 'Trang Điểm & Váy Cưới', rating: '5.0', price: 'Từ 8.500.000đ', img: 'https://images.unsplash.com/photo-1595956553066-ae24bfbc6841?auto=format&fit=crop&q=80&w=400' }
            ].map((vendor, i) => (
